...
*the weight files (.H5) are added as 2 parts each (for epoch = 10 and 20) in .rar format due to file size upload limit of github. It should be extracted before running the application. 
